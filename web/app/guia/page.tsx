...
const TOOLS: { icon: string; title: string; what: string; when: string; href?: string }[] = [
  ...
  { icon: "⚡", title: "Day Trades", what: "La sesión de HOY: el precio promedio del día, el rango de la primera media hora, los muros de dinero en vivo y la gráfica. Con ideas que se acaban hoy y su tope de pérdida.", when: "Cuando operas en el día (SPY = espejo de /ES y /MES) y quieres los niveles intradía.", href: "/daytrades" },
...
const GLOSSARY: { term: string; emoji: string; def: string }[] = [
  ...
  { term: "El precio donde cambia el día", emoji: "🔀", def: "Por encima, el mercado tiende a quedarse en un rango tranquilo; por debajo, se estira para un lado. En el bróker sale como gamma flip." },
  { term: "GEX (gamma)", emoji: "🧱", def: "Mide dónde está apilado el dinero de opciones. En día de rango el precio se queda quieto; en día de empujón se estira." },
  { term: "Precio promedio del día", emoji: "📏", def: "El precio al que de verdad se compró y vendió hoy, pesando más donde hubo más acciones. Si el precio va por encima, mandan los compradores. En el bróker sale como VWAP." },
  { term: "Probabilidad de ganar", emoji: "🎯", def: "De cada 100 veces que hagas la misma operación, cuántas terminan en ganancia. En el bróker sale como POP." },
  ...
  { term: "Vence hoy", emoji: "⏱️", def: "Contratos que se acaban al cierre de hoy: ganan o se hacen cero en unas horas. En el bróker sale como 0DTE." },
